...
const RAW_PROVIDERS = [
  ...
  { id: 'agnes', name: 'Agnes AI（生图/生视频聚合）', region: '国际', protocol: 'openai', baseUrl: 'https://apihub.agnes-ai.com/v1', models: ['agnes-2.0-flash', 'agnes-2.5-flash'], requiresKey: true, modelHint: '聊天与视觉用 agnes-2.0-flash；生图/生视频走创作工作室，已内置 agnes-image-2.1-flash 与 agnes-video-v2.0。' },
