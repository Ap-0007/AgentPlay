...
const RAW_PROVIDERS = [
  ...
  { id: 'agnes', name: 'Agnes AI（文本/图像/视频）', region: '国际', protocol: 'openai', baseUrl: 'https://apihub.agnes-ai.com/v1', models: ['agnes-2.5-flash', 'agnes-2.0-flash'], requiresKey: true, modelHint: '文本与视觉默认 agnes-2.5-flash；2.0仅作历史拒图回退。生图/生视频走创作工作室，已内置 agnes-image-2.1-flash 与 agnes-video-v2.0。' },
