...
const RAW_PROVIDERS = [
  ...
  { id: 'codex-chatgpt', name: 'ChatGPT 订阅（经 Codex CLI）', region: '本地', protocol: 'cli', baseUrl: '', models: ['gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna', 'gpt-5.5', 'gpt-5.4-mini'], requiresKey: false, modelHint: '复用本机 Codex CLI 的 ChatGPT 订阅登录态（官方 CLI 自管 OAuth），只读子进程调用，不产生 API 费用。' },
