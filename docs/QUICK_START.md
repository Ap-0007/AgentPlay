...
公开稳定版是 `0.7.6`，下载入口只认 [GitHub Releases](https://github.com/wg5759/AgentPlay/releases)。`0.9.1` 只作为明确标注 `NotSigned` 的 Preview Prerelease 提供给愿意核对 SHA-256 的测试者，未签名版本不会冒充稳定版。
