...
The current public stable release is [v0.7.6](https://github.com/wg5759/AgentPlay/releases/tag/v0.7.6). The newer 0.9.1 line is being published as an explicitly **unsigned Preview** for early testers.
