...
The current public stable release is [v0.7.6](https://github.com/wg5759/AgentPlay/releases/tag/v0.7.6). The newer line is available as [v0.9.1 Preview 1](https://github.com/wg5759/AgentPlay/releases/tag/v0.9.1-preview.1), an explicitly **unsigned GitHub Prerelease** for early testers.
