...
test('renderer presents remove-segment as a recoverable edit with every timeline mapping', () => {
  ...
  const types = read('src/types/global.d.ts')
  assert.match(tasks, /\['media\.trim', 'media\.remove-segment', 'media\.concat-segments', 'media\.add-music', 'media\.mix-audio', 'media\.visual-effects', 'media\.concat-sources', 'media\.burn-subtitles', 'media\.shift-subtitles', 'media\.mux-subtitles', 'media\.translate-subtitles', 'media\.edit-subtitle-cues'\]\.includes\(decision\.kind\)/)
  ...
  assert.match(runtime, /runtimeTask\.type === 'media\.edit-trim' \|\| runtimeTask\.type === 'media\.edit-remove' \|\| runtimeTask\.type === 'media\.edit-concat' \|\| runtimeTask\.type === 'media\.edit-music' \|\| runtimeTask\.type === 'media\.edit-audio-mix'/)
  assert.match(types, /kind: 'media\.trim' \| 'media\.remove-segment' \| 'media\.concat-segments' \| 'media\.add-music' \| 'media\.mix-audio' \| 'media\.visual-effects' \| 'media\.smart-reframe' \| 'media\.visual-repair' \| 'media\.concat-sources' \| 'media\.burn-subtitles' \| 'media\.shift-subtitles' \| 'media\.mux-subtitles' \| 'media\.translate-subtitles' \| 'media\.edit-subtitle-cues'/)
})
...
test('renderer and preload contracts present concat and reorder as one recoverable editing action', () => {
  ...
  assert.match(runtime, /runtimeTask\.type === 'media\.edit-concat' \|\| runtimeTask\.type === 'media\.edit-music' \|\| runtimeTask\.type === 'media\.edit-audio-mix'/)
